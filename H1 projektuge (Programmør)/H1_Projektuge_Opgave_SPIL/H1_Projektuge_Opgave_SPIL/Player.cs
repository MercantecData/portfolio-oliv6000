...
namespace H1_Projektuge_Opgave_SPIL
{
    class Player
    {
        ...
        public void update_Stats_With_Equipment(Equipment equipment, Player player)
        {
        ...
        public void at_Level_Up(Player player)
        {
            player.health = equipment_Health + (default_Health * (level * 0.85));
        }
        ...
        {
            Console.WriteLine("This is the weapon damage: " + weapon.damage_Buff);
